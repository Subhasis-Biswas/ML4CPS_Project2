...
\begin{figure}[htbp]
  \vspace{-1cm}
  \centering
  \subfigure[Joint Density of Suburb (Relative) Coordinates]{
      \includegraphics[scale=0.4]{figures/joint_density.png}
      \label{fig:jd_suburb}
  }
  \hspace{-0.3cm} % Adjust horizontal spacing
  \subfigure[MDS Plot of Population Fraction]{
      \includegraphics[scale=0.3]{suburbs_cartesian.png}
      \label{fig:mds_services}
  }
  
  \vspace{-0.4cm} % Adjust vertical spacing between rows of figures
  
  \subfigure[placeholder]{
      \includegraphics[scale=0.5]{mds_services.png}
      \label{fig:mds_services_placeholder}
  }
  \subfigure[placeholder]{
  ...
  \hspace{-0.4cm}
  \subfigure[placeholder]{
      \includegraphics[scale=0.5]{spectral_clustering.png}
